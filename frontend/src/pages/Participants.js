...
function Participants() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [participantsRes, userRes, myParticipantRes] = await Promise.all([
        ...
        axios.get(`${API_BASE_URL}/api/participants/me/`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        }),
      ...
      setMyParticipant(myParticipantRes.data);

      setEditForm({
        first_name: myParticipantRes.data.first_name || "",
        last_name: myParticipantRes.data.last_name || "",
        email: myParticipantRes.data.email || "",
        phone: myParticipantRes.data.phone || "",
      });
    } catch (err) {
      console.error(err);
                          ...
                          {editingParticipantId === participant.id ? (
                            <div className="participants-edit-form">
                              ...
                              <div className="participant-card-right">
                                <button
                                  className="participants-action-btn"
                                  onClick={() => handleAdminUpdate(participant.id)}
                                  type="button"
                                >
                                  Save
                                </button>
